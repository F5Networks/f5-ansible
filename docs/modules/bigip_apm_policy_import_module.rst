            ...
            <th>Choices/<font color="blue">Defaults</font></th>
                    ...
                    <b>source</b>
                                ...
                                <td>
                                                    ...
                                                    <div>Files exported from newer versions of BIG-IP cannot be imported into older versions of BIG-IP.</div>
                                                    <div>{&#x27;This restriction applies to major release trains&#x27;: &#x27;c(12.x) c(13.x) c(14.x) and so on.&#x27;}</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    <b>type</b>
                                ...
                                <td>
                                                                                                                            <ul><b>Choices:</b>
                                                                                                                                                                <li><div style="color: blue"><b>profile_access</b>&nbsp;&larr;</div></li>
                                                                                                                                                                                                <li>access_policy</li>
                                                                                    </ul>
                                                                            </td>
                                                                <td>
                                                                        <div>Specifies the type of item to export from device.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
            ...
            <th width="100%">Description</th>
                ...
                <td>
                                ...
                                <td colspan="1">
                    <b>source</b>
                    <br/><div style="font-size: small; color: red">path</div>
                </td>
                <td>changed</td>
                <td>
                ...
                <td>changed</td>
                <td>
                                            <div>Set to specify type of item to export.</div>
                                        <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">access_policy</div>
                                    </td>
            </tr>
                        </table>
    <br/><br/>
