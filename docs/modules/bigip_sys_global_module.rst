:source: modules/bigip_sys_global.py

:orphan:

.. _bigip_sys_global_module:
            ...
            <th>Choices/<font color="blue">Defaults</font></th>
                    ...
                    <b>banner_text</b>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Specifies the text to present in the advisory banner.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    <b>console_timeout</b>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Specifies the number of seconds of inactivity before the system logs off a user that is logged on.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    ...
                    <b>mgmt_dhcp</b>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Specifies whether or not to enable DHCP client on the management interface</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    ...
                    <b>security_banner</b>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Specifies whether the system displays an advisory message on the login screen.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
...
.. raw:: html
    ...
    <table border=0 cellpadding=0 class="documentation-table">
            ...
            <th width="100%">Description</th>
                ...
                <td>changed</td>
                <td>
                                            <div>The new text to present in the advisory banner.</div>
                                        <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">This is a corporate device. Do not touch.</div>
                                    </td>
            </tr>
                                <tr>
                                <td colspan="1">
...
.. hint::
    If you notice any issues in this documentation you can `edit this document <https://github.com/ansible/ansible/edit/devel/lib/ansible/modules/modules/bigip_sys_global.py?description=%3C!---%20Your%20description%20here%20--%3E%0A%0A%2Blabel:%20docsite_pr>`_ to improve it.
