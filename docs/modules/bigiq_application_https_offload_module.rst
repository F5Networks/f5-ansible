:source: bigiq_application_https_offload.py
            ...
            <th>Choices/<font color="blue">Defaults</font></th>
                    ...
                    <b>netmask</b>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Specifies the netmask to associate with the given <code>address</code>.</div>
                                                    <div>This parameter is required when creating a new application.</div>
                                                                                </td>
            </tr>
                                <tr>
                    ...
                    <b>service_environment</b>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Specifies the name of service environment or the hostname of the BIG-IP that the application will be deployed to.</div>
