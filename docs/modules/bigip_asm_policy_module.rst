:source: modules/bigip_asm_policy.py
            ...
            <th>Choices/<font color="blue">Defaults</font></th>
                    ...
                    <b>force</b>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Specifies whether or not to force the uploading of an ASM policy.</div>
                                                    <div>When <code>yes</code>, will force update the policy even if there is a policy with the given name that already exists.</div>
                                                    <div>When <code>no</code>, will create the policy only if it does not already exist.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
