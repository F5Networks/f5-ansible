:source: modules/bigip_provision.py

:orphan:

.. _bigip_provision_module:
            ...
            <th>Choices/<font color="blue">Defaults</font></th>
                    ...
                    <b>level</b>
                                ...
                                <td>
                                                                                                                            <ul><b>Choices:</b>
                                                                                                                                                                <li>dedicated</li>
                                                                                                                                                                                                <li><div style="color: blue"><b>nominal</b>&nbsp;&larr;</div></li>
                                                                                                                                                                                                <li>minimum</li>
                                                                                    </ul>
                                                                            </td>
                                                                <td>
                    ...
                    <br/><div style="font-size: small; color: red">required</div>                                    </td>
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>The module to provision in BIG-IP.</div>
...
.. raw:: html
    ...
    <table border=0 cellpadding=0 class="documentation-table">
            ...
            <th width="100%">Description</th>
                ...
                <td>changed</td>
                <td>
                                            <div>The new provisioning level of the module.</div>
                                        <br/>
...
.. hint::
    If you notice any issues in this documentation you can `edit this document <https://github.com/ansible/ansible/edit/devel/lib/ansible/modules/modules/bigip_provision.py?description=%3C!---%20Your%20description%20here%20--%3E%0A%0A%2Blabel:%20docsite_pr>`_ to improve it.
