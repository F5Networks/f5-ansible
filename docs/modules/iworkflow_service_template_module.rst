...
.. raw:: html
    ...
    <th class="head">comments</th>
            ...
            <tr>
    <td>base_template<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td>None</td>
        <td><ul></ul></td>
...
.. note:: Requires the deepdiff Python package on the Ansible controller host. This is as easy as pip install deepdiff.
