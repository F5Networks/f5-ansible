    ...
    <table  border=0 cellpadding=0 class="documentation-table">
            ...
            <th class="head"><div class="cell-border">Choices/<font color="blue">Defaults</font></div></th>
                    ...
                    <div class="cell-border">
                                                                ...
                                                                <td>
                    <div class="cell-border">
                                                                                    <div>Loads the specified configuration that you want to merge into the running configuration. This is equivalent to using the <code>tmsh</code> command <code>load sys config from-terminal merge</code>. If you need to read configuration from a file or template, use Ansible&#x27;s <code>file</code> or <code>template</code> lookup plugins respectively.</div>
                                                                                                </div>
                </td>
            </tr>
                                <tr class="return-value-column">
                    ...
                    <div class="cell-border">
                                                                ...
                                                                <td>
                    <div class="cell-border">
                                                                                    <div>Loads the default configuration on the device. If this option is specified, the default configuration will be loaded before any commands or other provided configuration is run.</div>
                                                                                                </div>
                </td>
            </tr>
                                <tr class="return-value-column">
                    ...
                    <div class="cell-border">
                                                                ...
                                                                <td>
                    <div class="cell-border">
                                                                                    <div>Validates the specified configuration to see whether they are valid to replace the running configuration. The running configuration will not be changed.</div>
                                                                                                </div>
                </td>
            </tr>
                        </table>
