...
.. raw:: html
    ...
    <td></td>
        <td></td>
        <td><div>Individual addresses that you want to add to the list. These addresses differ from ranges, and lists of lists such as what can be used in <code>address_ranges</code> and <code>address_lists</code> respectively.</div><div>This list can also include networks that have CIDR notation.</div>        </td></tr>
