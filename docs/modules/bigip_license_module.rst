...
.. raw:: html
    ...
    <td></td>
        <td><ul></ul></td>
        <td><div>The password of the user used to authenticate to the BIG-IP</div></td></tr>
            <tr>
    <td>server<br/><div style="font-size: small;"></div></td>
    <td>yes</td>
    <td></td>
        <td><ul></ul></td>
        <td><div>BIG-IP host to connect to</div></td></tr>
            <tr>
    ...
    <td></td>
        <td><ul></ul></td>
        <td><div>The username used when connecting to the BIG-IP</div></br>
