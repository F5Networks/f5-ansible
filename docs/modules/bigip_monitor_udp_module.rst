...
.. raw:: html
    ...
    <td>/Common/udp</td>
        <td></td>
        <td><div>The parent template of this monitor template. Once this value has been set, it cannot be changed. By default, this value is the <code>udp</code> parent on the <code>Common</code> partition.</div>        </td></tr>
    ...
    <td></td>
        <td></td>
        <td><div>The send string for the monitor call. When creating a new monitor, if this value is not provided, the default <code>default send string</code> will be used.</div>        </td></tr>
                <tr><td>server<br/><div style="font-size: small;"></div></td>
    <td>yes</td>
    <td></td>
        <td></td>
