            ...
            <th>Choices/<font color="blue">Defaults</font></th>
                    ...
                    <b>delay</b>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Number of seconds to wait before starting to poll.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    <b>msg</b>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>This overrides the normal error message from a failure to meet the required conditions.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    ...
                    <b>sleep</b>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Number of seconds to sleep between checks, before 2.3 this was hardcoded to 1 second.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    <b>timeout</b>
                                ...
                                <td>
                                                                                                                                                                    <b>Default:</b><br/><div style="color: blue">7200</div>
                                    </td>
                                                                <td>
...
.. hint::
    If you notice any issues in this documentation you can `edit this document <https://github.com/ansible/ansible/edit/devel/lib/ansible/modules/modules/bigip_wait.py?description=%3C!---%20Your%20description%20here%20--%3E%0A%0A%2Blabel:%20docsite_pr>`_ to improve it.
