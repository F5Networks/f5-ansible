            ...
            <th>Choices/<font color="blue">Defaults</font></th>
                    ...
                    <b>state</b>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>When <code>state</code> is <code>present</code>, ensures that the rule list exists.</div>
                                                    <div>When <code>state</code> is <code>absent</code>, ensures that the rule list is removed.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
