:source: modules/bigip_profile_udp.py

:orphan:

.. _bigip_profile_udp_module:
            ...
            <th>Choices/<font color="blue">Defaults</font></th>
                    ...
                    <b>datagram_load_balancing</b>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Specifies, when <code>yes</code>, that the system load balances UDP traffic packet-by-packet.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    ...
                    <b>parent</b>
                                ...
                                <td>
                                                    ...
                                                    <div>When creating a new profile, if this parameter is not specified, the default is the system-supplied <code>udp</code> profile.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
...
.. raw:: html
    ...
    <table border=0 cellpadding=0 class="documentation-table">
            ...
            <th width="100%">Description</th>
                ...
                <td>changed</td>
                <td>
                                            <div>The new datagram load balancing setting of the resource.</div>
                                        <br/>
...
.. hint::
    If you notice any issues in this documentation you can `edit this document <https://github.com/ansible/ansible/edit/devel/lib/ansible/modules/modules/bigip_profile_udp.py?description=%3C!---%20Your%20description%20here%20--%3E%0A%0A%2Blabel:%20docsite_pr>`_ to improve it.
