...
_bigip_node - Manages F5 BIG-IP LTM nodes
+++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
    ...
    <td></td>
        <td></td>
        <td><div>Node IP. Required when state=present and node does not exist. Error when <code>state</code> is <code>absent</code>.</div></br>
