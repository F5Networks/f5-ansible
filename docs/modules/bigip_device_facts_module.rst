    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th class="head" width="100%"><div class="cell-border">Description</div></th>
                ...
                <td><div class="cell-border">when <code>device_groups</code> is specified in <code>gather_subset</code>.</div></td>
                <td>
                    <div class="cell-border">
                ...
                <td><div class="cell-border">when <code>devices</code> is specified in <code>gather_subset</code>.</div></td>
                <td>
                    <div class="cell-border">
                ...
                <td><div class="cell-border">when <code>fasthttp_profiles</code> is specified in <code>gather_subset</code>.</div></td>
                <td>
                    <div class="cell-border">
