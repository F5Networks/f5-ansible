...
# links to sections
rst_epilog = """
.. _redirect_software_module: %(base_url)s/ansible/devel/modules/bigip_software_image_module.htm
"""% {
...
html_title = "F5 Modules for Ansible Documentation"
...
latex_documents = [
    (master_doc, 'F5Ansible.tex', u'F5 Modules for Ansible',
...
man_pages = [
    (master_doc, 'f5ansible', u'F5 Modules for Ansible',
     [author], 1)
]
