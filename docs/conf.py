...
.. |delete| replace:: :meth:`~f5.bigip.resource.Resource.delete`

.. |load| replace:: :meth:`~f5.bigip.resource.Resource.load`

.. |exists| replace:: :meth:`~f5.bigip.resource.Resource.exists`
"""
