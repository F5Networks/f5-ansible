...
# this file is a temporary workaround as it is used in a bigip plugin,
# which causes problems on non devel version of Ansible prior 2.8 release,
# preventing f5ansible galaxy role usage. This file will be removed.
