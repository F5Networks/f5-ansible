    ...
    suboptions:
      ...
      continent:
        description:
          ...
          - Specifying Unknown forces the system to use a default resolution
...
class ModuleParameters(Parameters):
    countries = {
        ...
        'Costa Rica': 'CR', "Cote D'Ivoire": 'CI', 'Croatia': 'HR', 'Cuba': 'CU', 'Curaçao': 'CW', 'Cyprus': 'CY',
        ...
        'Estonia': 'EE', 'Ethiopia': 'ET', 'Falkland Islands (Malvinas)': 'FK', 'Faroe Islands': 'FO', 'Fiji': 'FJ',
        ...
        'Luxembourg': 'LU', 'Macau': 'MO', 'Macedonia': 'MK', 'Madagascar': 'MG', 'Malawi': 'MW', 'Malaysia': 'MY',
        ...
        'Philippines': 'PH', 'Pitcairn Islands': 'PN', 'Poland': 'PL', 'Portugal': 'PT', 'Puerto Rico': 'PR',
        ...
        'Venezuela': 'VE', 'Vietnam': 'VN', 'Virgin Islands, British': 'VG', 'Virgin Islands, U.S.': 'VI',
        'Wallis and Futuna': 'WF', 'Western Sahara': 'EH', 'Yemen': 'YE', 'Zambia': 'ZM', 'Zimbabwe': 'ZW',
        'Unrecognized': 'N/A', 'Asia/Pacific Region': 'AP', 'Europe': 'EU', 'Netherlands Antilles': 'AN',
        'France, Metropolitan': 'FX', 'Anonymous Proxy': 'A1', 'Satellite Provider': 'A2', 'Other': 'O1'
    }

    continents = {
        'Antarctica': 'AN', 'Asia': 'AS', 'Africa': 'AF', 'Europe': 'EU', 'North America': 'NA',
        'South America': 'SA', 'Oceania': 'OC', 'Unknown': '--'
    }
    ...
    def source(self):
        options = {
            'negate': self.src_negate, 'subnet': self.src_subnet, 'region': self.src_region,
            'continent': self.src_continent, 'country': self.src_country, 'state': self.src_state,
            'isp': self.src_isp, 'geoip-isp': self.src_geo_isp
        }
    ...
    def destination(self):
        options = {
            'negate': self.dst_negate, 'subnet': self.dst_subnet, 'region': self.dst_region,
            'continent': self.dst_continent, 'country': self.dst_country, 'state': self.dst_state,
            'datacenter': self.dst_datacenter, 'pool': self.dst_pool,
            'isp': self.dst_isp, 'geoip-isp': self.dst_geo_isp
        }
    ...
    def __init__(self):
        ...
        argument_spec = dict(
            ...
            destination=dict(
                ...
                mutually_exclusive=[[
                    'subnet', 'region', 'continent', 'country',
                    'pool', 'datacenter', 'isp', 'geo_isp'
                ]]
            ),
