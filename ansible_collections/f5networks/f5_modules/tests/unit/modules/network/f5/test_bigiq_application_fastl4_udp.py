...
from ansible_collections.f5networks.f5_modules.plugins.modules.bigiq_application_fastl4_udp import (
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        self.p5 = patch('ansible_collections.f5networks.f5_modules.plugins.modules.bigiq_application_fastl4_udp.send_teem')
