...
from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_iapp_service import (
    Parameters, ApiParameters, ModuleParameters, ModuleManager, ArgumentSpec
)
...
class TestManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.p2 = patch('ansible_collections.f5networks.f5_modules.plugins.modules.bigip_iapp_service.tmos_version')
        self.p3 = patch('ansible_collections.f5networks.f5_modules.plugins.modules.bigip_iapp_service.send_teem')
