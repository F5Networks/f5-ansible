...
from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_apm_policy_import import (
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        self.p2 = patch('ansible_collections.f5networks.f5_modules.plugins.modules.bigip_apm_policy_import.tmos_version')
        self.p3 = patch('ansible_collections.f5networks.f5_modules.plugins.modules.bigip_apm_policy_import.send_teem')
