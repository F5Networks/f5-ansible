...
from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_monitor_external import (
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        self.p3 = patch('ansible_collections.f5networks.f5_modules.plugins.modules.bigip_monitor_external.send_teem')
