...
from ansible_collections.f5networks.f5_modules.plugins.modules.bigiq_application_https_offload import (
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        self.p5 = patch('ansible_collections.f5networks.f5_modules.plugins.modules.bigiq_application_https_offload.send_teem')
