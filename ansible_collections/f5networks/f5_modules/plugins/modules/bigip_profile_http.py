...
options:
  ...
  hsts_preload:
    description:
      - When set to C(true), adds the HSTS host and its subdomains to the browser's
    ...
    suboptions:
      truncated_redirects:
        description:
          ...
          - If C(true), the redirect is forwarded to the client, otherwise the malformed HTTP
            is silently ignored.
