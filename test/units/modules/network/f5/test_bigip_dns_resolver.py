...
try:
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_dns_resolver import ApiParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_dns_resolver import ModuleParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_dns_resolver import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_dns_resolver import ArgumentSpec
