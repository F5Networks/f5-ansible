...
try:
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_management_route import ApiParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_management_route import ModuleParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_management_route import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_management_route import ArgumentSpec
