...
try:
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_gtm_pool_member import ApiParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_gtm_pool_member import ModuleParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_gtm_pool_member import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_gtm_pool_member import ArgumentSpec
