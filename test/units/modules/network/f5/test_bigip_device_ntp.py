...
try:
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_device_ntp import Parameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_device_ntp import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_device_ntp import ArgumentSpec
