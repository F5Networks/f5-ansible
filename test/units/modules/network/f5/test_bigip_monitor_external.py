...
try:
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_monitor_external import ModuleParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_monitor_external import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_monitor_external import ArgumentSpec
