...
try:
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_firewall_port_list import ApiParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_firewall_port_list import ModuleParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_firewall_port_list import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_firewall_port_list import ArgumentSpec
