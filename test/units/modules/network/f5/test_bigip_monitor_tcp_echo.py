...
try:
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_monitor_tcp_echo import Parameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_monitor_tcp_echo import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_monitor_tcp_echo import ArgumentSpec
