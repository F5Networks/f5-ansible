...
try:
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_profile_oneconnect import ApiParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_profile_oneconnect import ModuleParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_profile_oneconnect import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_profile_oneconnect import ArgumentSpec
