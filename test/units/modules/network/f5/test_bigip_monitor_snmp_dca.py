...
try:
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_monitor_snmp_dca import Parameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_monitor_snmp_dca import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_monitor_snmp_dca import ArgumentSpec
