...
try:
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigiq_device_discovery import ApiParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigiq_device_discovery import ModuleParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigiq_device_discovery import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigiq_device_discovery import ArgumentSpec
