...
try:
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_routedomain import ApiParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_routedomain import ModuleParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_routedomain import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_routedomain import ArgumentSpec
