...
try:
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_virtual_server import ApiParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_virtual_server import ModuleParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_virtual_server import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_virtual_server import ArgumentSpec
