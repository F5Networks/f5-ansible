...
try:
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_smtp import ApiParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_smtp import ModuleParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_smtp import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_smtp import ArgumentSpec
