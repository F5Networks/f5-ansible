...
try:
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_gtm_monitor_bigip import ApiParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_gtm_monitor_bigip import ModuleParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_gtm_monitor_bigip import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_gtm_monitor_bigip import ArgumentSpec
