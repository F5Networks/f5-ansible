...
try:
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_policy_rule import ModuleParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_policy_rule import ApiParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_policy_rule import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_policy_rule import ArgumentSpec
