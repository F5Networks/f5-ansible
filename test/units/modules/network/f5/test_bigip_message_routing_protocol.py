...
try:
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_message_routing_protocol import ApiParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_message_routing_protocol import ModuleParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_message_routing_protocol import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_message_routing_protocol import ArgumentSpec
