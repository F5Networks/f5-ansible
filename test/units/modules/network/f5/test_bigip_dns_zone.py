...
try:
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_dns_zone import ApiParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_dns_zone import ModuleParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_dns_zone import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_dns_zone import ArgumentSpec
