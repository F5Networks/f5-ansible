...
try:
    from library.modules.bigip_profile_sip import ApiParameters
    from library.modules.bigip_profile_sip import ModuleParameters
    from library.modules.bigip_profile_sip import ModuleManager
    from library.modules.bigip_profile_sip import ArgumentSpec
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_profile_sip import ApiParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_profile_sip import ModuleParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_profile_sip import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_profile_sip import ArgumentSpec
