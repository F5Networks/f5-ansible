...
try:
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_sys_db import Parameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_sys_db import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_sys_db import ArgumentSpec
