...
try:
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_password_policy import ApiParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_password_policy import ModuleParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_password_policy import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_password_policy import ArgumentSpec
