...
try:
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_profile_udp import ApiParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_profile_udp import ModuleParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_profile_udp import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_profile_udp import ArgumentSpec
