...
try:
    ...
    from ansible.modules.network.f5.bigip_cgnat_lsn_pool import ApiParameters
    from ansible.modules.network.f5.bigip_cgnat_lsn_pool import ModuleParameters
    from ansible.modules.network.f5.bigip_cgnat_lsn_pool import ModuleManager
    from ansible.modules.network.f5.bigip_cgnat_lsn_pool import ArgumentSpec
