...
try:
    from library.modules.bigip_cgnat_lsn_pool import ApiParameters
    from library.modules.bigip_cgnat_lsn_pool import ModuleParameters
    from library.modules.bigip_cgnat_lsn_pool import ModuleManager
    from library.modules.bigip_cgnat_lsn_pool import ArgumentSpec
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_cgnat_lsn_pool import ApiParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_cgnat_lsn_pool import ModuleParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_cgnat_lsn_pool import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_cgnat_lsn_pool import ArgumentSpec
