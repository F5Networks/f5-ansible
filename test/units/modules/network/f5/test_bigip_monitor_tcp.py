...
try:
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_monitor_tcp import Parameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_monitor_tcp import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_monitor_tcp import ArgumentSpec
