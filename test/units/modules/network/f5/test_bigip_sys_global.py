...
try:
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_sys_global import ApiParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_sys_global import ModuleParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_sys_global import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_sys_global import ArgumentSpec
