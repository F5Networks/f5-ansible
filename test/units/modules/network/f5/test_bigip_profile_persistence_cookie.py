...
try:
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_profile_persistence_cookie import ApiParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_profile_persistence_cookie import ModuleParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_profile_persistence_cookie import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_profile_persistence_cookie import ArgumentSpec
