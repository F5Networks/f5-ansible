...
try:
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_software_install import ApiParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_software_install import ModuleParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_software_install import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_software_install import ArgumentSpec
