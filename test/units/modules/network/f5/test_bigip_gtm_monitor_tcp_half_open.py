...
try:
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_gtm_monitor_tcp_half_open import ApiParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_gtm_monitor_tcp_half_open import ModuleParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_gtm_monitor_tcp_half_open import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_gtm_monitor_tcp_half_open import ArgumentSpec
