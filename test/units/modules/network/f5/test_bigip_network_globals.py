...
try:
    from library.modules.bigip_network_globals import ApiParameters
    from library.modules.bigip_network_globals import ModuleParameters
    from library.modules.bigip_network_globals import ModuleManager
    from library.modules.bigip_network_globals import ArgumentSpec
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_network_globals import ApiParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_network_globals import ModuleParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_network_globals import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_network_globals import ArgumentSpec
