...
try:
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_imish_config import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_imish_config import ArgumentSpec
