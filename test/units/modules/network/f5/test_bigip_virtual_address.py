...
try:
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_virtual_address import ApiParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_virtual_address import ModuleParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_virtual_address import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_virtual_address import ArgumentSpec
