...
try:
    from library.modules.bigip_monitor_oracle import ApiParameters
    from library.modules.bigip_monitor_oracle import ModuleParameters
    from library.modules.bigip_monitor_oracle import ModuleManager
    from library.modules.bigip_monitor_oracle import ArgumentSpec
    from test.units.compat import unittest
    from test.units.compat.mock import Mock
    from test.units.compat.mock import patch
    from test.units.compat.utils import set_module_args
except ImportError:
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_monitor_oracle import ApiParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_monitor_oracle import ModuleParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_monitor_oracle import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_monitor_oracle import ArgumentSpec
