...
try:
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_partition import ApiParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_partition import ModuleParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_partition import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_partition import ArgumentSpec
