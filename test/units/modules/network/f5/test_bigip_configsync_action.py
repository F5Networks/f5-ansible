...
try:
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_configsync_action import Parameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_configsync_action import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_configsync_action import ArgumentSpec
