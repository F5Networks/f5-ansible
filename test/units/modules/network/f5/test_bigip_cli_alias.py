...
try:
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_cli_alias import ApiParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_cli_alias import ModuleParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_cli_alias import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_cli_alias import ArgumentSpec
