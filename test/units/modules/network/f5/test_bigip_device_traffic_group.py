...
try:
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_device_traffic_group import ApiParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_device_traffic_group import ModuleParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_device_traffic_group import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_device_traffic_group import ArgumentSpec
