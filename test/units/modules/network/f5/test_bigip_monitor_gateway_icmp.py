...
try:
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_monitor_gateway_icmp import ApiParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_monitor_gateway_icmp import ModuleParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_monitor_gateway_icmp import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_monitor_gateway_icmp import ArgumentSpec
