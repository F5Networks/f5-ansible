...
try:
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_software_image import ApiParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_software_image import ModuleParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_software_image import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_software_image import ArgumentSpec
