...
try:
    from library.modules.bigip_gtm_dns_listener import ApiParameters
    from library.modules.bigip_gtm_dns_listener import ModuleParameters
    from library.modules.bigip_gtm_dns_listener import ModuleManager
    from library.modules.bigip_gtm_dns_listener import ArgumentSpec
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_gtm_dns_listener import ApiParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_gtm_dns_listener import ModuleParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_gtm_dns_listener import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_gtm_dns_listener import ArgumentSpec
