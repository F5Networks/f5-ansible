...
try:
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_snmp import ApiParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_snmp import ModuleParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_snmp import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_snmp import ArgumentSpec
