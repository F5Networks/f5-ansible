...
try:
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_snat_pool import ModuleParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_snat_pool import ApiParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_snat_pool import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_snat_pool import ArgumentSpec
