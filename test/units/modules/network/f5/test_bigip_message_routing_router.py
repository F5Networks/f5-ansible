...
try:
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_message_routing_router import ApiParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_message_routing_router import ModuleParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_message_routing_router import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_message_routing_router import GenericModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_message_routing_router import ArgumentSpec
