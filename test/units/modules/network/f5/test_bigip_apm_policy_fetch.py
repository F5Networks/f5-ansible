...
try:
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_apm_policy_fetch import ModuleParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_apm_policy_fetch import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_apm_policy_fetch import ArgumentSpec
