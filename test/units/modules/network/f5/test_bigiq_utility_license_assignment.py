...
try:
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigiq_utility_license_assignment import ModuleParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigiq_utility_license_assignment import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigiq_utility_license_assignment import ArgumentSpec
