...
try:
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_firewall_rule_list import ModuleParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_firewall_rule_list import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_firewall_rule_list import ArgumentSpec
