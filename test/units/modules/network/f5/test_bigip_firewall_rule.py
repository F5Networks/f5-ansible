...
try:
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_firewall_rule import ModuleParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_firewall_rule import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_firewall_rule import ArgumentSpec
