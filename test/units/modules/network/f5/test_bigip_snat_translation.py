...
try:
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_snat_translation import ApiParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_snat_translation import ModuleParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_snat_translation import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_snat_translation import ArgumentSpec
