...
try:
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_profile_http2 import ApiParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_profile_http2 import ModuleParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_profile_http2 import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_profile_http2 import ArgumentSpec
