...
try:
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_log_publisher import ApiParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_log_publisher import ModuleParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_log_publisher import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.bigip_log_publisher import ArgumentSpec
