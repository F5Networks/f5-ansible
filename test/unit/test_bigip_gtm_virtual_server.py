...
try:
    from library.bigip_gtm_virtual_server import ApiParameters
    from library.bigip_gtm_virtual_server import ModuleParameters
    from library.bigip_gtm_virtual_server import ModuleManager
    from library.bigip_gtm_virtual_server import ArgumentSpec
