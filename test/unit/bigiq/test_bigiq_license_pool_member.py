...
try:
    from library.bigiq_license_pool_member import Parameters
    from library.bigiq_license_pool_member import ModuleManager
    from library.bigiq_license_pool_member import ArgumentSpec
except ImportError:
    try:
        from ansible.modules.network.f5.bigiq_license_pool_member import Parameters
        from ansible.modules.network.f5.bigiq_license_pool_member import ModuleManager
        from ansible.modules.network.f5.bigiq_license_pool_member import ArgumentSpec
    except ImportError:
