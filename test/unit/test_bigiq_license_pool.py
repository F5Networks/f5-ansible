...
try:
    from library.bigiq_license_pool import Parameters
    from library.bigiq_license_pool import ModuleManager
    from library.bigiq_license_pool import ArgumentSpec
except ImportError:
    try:
        from ansible.modules.network.f5.bigiq_license_pool import Parameters
        from ansible.modules.network.f5.bigiq_license_pool import ModuleManager
        from ansible.modules.network.f5.bigiq_license_pool import ArgumentSpec
    except ImportError:
