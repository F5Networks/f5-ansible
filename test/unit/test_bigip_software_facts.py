...
try:
    from library.modules.bigip_software_facts import Parameters
    from library.modules.bigip_software_facts import ModuleManager
    from library.modules.bigip_software_facts import ArgumentSpec
    from library.modules.bigip_software_facts import F5ModuleError
