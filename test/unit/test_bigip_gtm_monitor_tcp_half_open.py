...
try:
    from library.bigip_gtm_monitor_tcp_half_open import ApiParameters
    from library.bigip_gtm_monitor_tcp_half_open import ModuleParameters
    from library.bigip_gtm_monitor_tcp_half_open import ModuleManager
    from library.bigip_gtm_monitor_tcp_half_open import ArgumentSpec
