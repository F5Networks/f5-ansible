...
try:
    from library.bigiq_regkey_license_assignment import Parameters
    from library.bigiq_regkey_license_assignment import ModuleManager
    from library.bigiq_regkey_license_assignment import ArgumentSpec
    from library.module_utils.network.f5.common import F5ModuleError
    from library.module_utils.network.f5.common import iControlUnexpectedHTTPError
    from test.unit.modules.utils import set_module_args
except ImportError:
    try:
        from ansible.modules.network.f5.bigiq_regkey_license_assignment import Parameters
