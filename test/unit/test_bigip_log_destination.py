...
try:
    from library.modules.bigip_log_destination import ApiParameters
    from library.modules.bigip_log_destination import ModuleParameters
    ...
    try:
        from ansible.modules.network.f5.bigip_log_destination import ApiParameters
        from ansible.modules.network.f5.bigip_log_destination import ModuleParameters
