...
try:
    from library.bigip_snmp_trap import V2Parameters
    from library.bigip_snmp_trap import V1Parameters
    from library.bigip_snmp_trap import ModuleManager
    from library.bigip_snmp_trap import V2Manager
    from library.bigip_snmp_trap import V1Manager
