...
try:
    from library.bigip_regkey_pool import Parameters
    from library.bigip_regkey_pool import ModuleManager
    from library.bigip_regkey_pool import ArgumentSpec
    from ansible.module_utils.f5_utils import iControlUnexpectedHTTPError
except ImportError:
    try:
        from ansible.modules.network.f5.bigip_regkey_pool import Parameters
        from ansible.modules.network.f5.bigip_regkey_pool import ModuleManager
        from ansible.modules.network.f5.bigip_regkey_pool import ArgumentSpec
        from ansible.module_utils.f5_utils import iControlUnexpectedHTTPError
    except ImportError:
